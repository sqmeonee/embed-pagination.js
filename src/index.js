...
async function slashPaginate(options = {}) {
    try {
        ...
        if (!options.disable.beginning) options.disable.beginning = false;
        if (!options.disable.end) options.disable.end = false;
        if (!options.disable.placeholder) options.disable.placeholder = false;
        
        if (typeof options.disable.beginning !== 'boolean') throw new TypeError("disable.beginning is not of type boolean")
        if (typeof options.disable.end !== 'boolean') throw new TypeError("disable.end is not of type boolean")
        if (typeof options.disable.placeholder !== 'boolean') throw new TypeError("disable.placeholder is not of type boolean")
    
        if(!Array.isArray(options.pages)) throw new TypeError('Pages is not of type array')
        ...
        const buttonRow = new ActionRowBuilder() // setComponents, addComponents

        if (options.disable.beginning == false) buttonRow.addComponents(beginning)
        buttonRow.addComponents(prev)
        if (options.disable.placeholder == false) buttonRow.addComponents(none)
        buttonRow.addComponents(next)
        if (options.disable.end == false) buttonRow.addComponents(end) 
